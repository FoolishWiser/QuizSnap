...
public final class ActivityHistoryBinding implements ViewBinding {
  ...
  @NonNull
  public final MaterialButton btnAddQuiz;
  ...
  private ActivityHistoryBinding(@NonNull LinearLayout rootView, @NonNull MaterialButton btnAddQuiz,
      @NonNull MaterialButton btnRefresh, @NonNull RecyclerView recyclerViewHistory,
  ...
  public static ActivityHistoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.btnAddQuiz;
      MaterialButton btnAddQuiz = ViewBindings.findChildViewById(rootView, id);
      if (btnAddQuiz == null) {
        break missingId;
      }
      ...
      return new ActivityHistoryBinding((LinearLayout) rootView, btnAddQuiz, btnRefresh,
          recyclerViewHistory, tvCount);
    }
